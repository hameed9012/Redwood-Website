...
export function Section({ id, children, className = '' }: SectionProps) {
  ...
  return (
    <section id={id} className="relative flex min-h-[100svh] items-center justify-center px-6 py-24">
      <div
        ref={ref}
        className={`w-full max-w-4xl rounded-2xl border border-rw-bone/10 bg-rw-black/55 p-8 backdrop-blur-md transition-all duration-[900ms] ease-out md:p-12 ${
